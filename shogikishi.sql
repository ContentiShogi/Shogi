...
select _id [#]
	...
	,case when preferred_style is not null then '=HYPERLINK("https://shogidata.info/personal/'
			+replace(replace(replace(replace(replace(replace(
				lower(lastname+firstname)
			,'Yuuya','|'),'inoue','||'),'Souta','Sota'),'uu','u'),'|','Yuuya'),'|','Inoue')
		+'.html","'+lastname+'")'else ''end [Latest info]
...
--update kishi set preferred_style =''
--/*styles.style2*/
--from (select styles.jpname,isnull(kishi.preferred_style,N'')preferred_style,kishi._id,replace(
--replace(replace(
--replace(case when isnull(kishi.preferred_style,N'')=N'' then max(styles.style)+N' '+min(styles.style) else kishi.preferred_style end,N'Furibisha Furibisha',N'Furibisha')
--,N'Furibisha Ibisha',N'All rounder'),N'Ibisha Furibisha',N'All rounder')
--,N'Ibisha Ibisha',N'Ibisha')+
--N' | '+string_agg(substyle,N' | ')+N' |'style
--from(values 
-- (N'Ibisha',N'矢倉',N'内山あや')
--,(N'Ibisha',N'矢倉',N'塚田恵梨花')
--,(N'Ibisha',N'矢倉',N'加藤結李愛')
--,(N'Ibisha',N'矢倉',N'伊藤沙恵')
--,(N'Ibisha',N'矢倉',N'中井広恵')
--,(N'Ibisha',N'角換わり',N'中澤沙耶')
--,(N'Ibisha',N'角換わり',N'加藤結李愛')
--,(N'Ibisha',N'角換わり',N'山口恵梨子')
--,(N'Ibisha',N'角換わり',N'塚田恵梨花')
--,(N'Ibisha',N'角換わり',N'内山あや')
--,(N'Ibisha',N'横歩取り',N'中井広恵')
--,(N'Ibisha',N'横歩取り',N'渡部愛')
--,(N'Ibisha',N'横歩取り',N'加藤桃子')
--,(N'Ibisha',N'相掛かり',N'加藤結李愛')
--,(N'Ibisha',N'相掛かり',N'野原未蘭')
--,(N'Ibisha',N'相掛かり',N'渡部愛')
--,(N'Ibisha',N'相掛かり',N'加藤桃子')
--,(N'Ibisha',N'相掛かり',N'塚田恵梨花')
--,(N'Ibisha',N'力戦',N'山田久美')
--,(N'Ibisha',N'力戦',N'野原未蘭')
--,(N'Ibisha',N'力戦',N'中澤沙耶')
--,(N'Ibisha',N'力戦',N'千葉涼子')
--,(N'Ibisha',N'力戦',N'山口恵梨子')
--,(N'Ibisha',N'対振り飛車',N'鈴木環那')
--,(N'Ibisha',N'対振り飛車',N'加藤桃子')
--,(N'Ibisha',N'対振り飛車',N'渡部愛')
--,(N'Ibisha',N'対振り飛車',N'中井広恵')
--,(N'Ibisha',N'対振り飛車',N'加藤圭')
--,(N'Furibisha',N'中飛車',N'小高佐季子')
--,(N'Furibisha',N'中飛車',N'佐々木海法')
--,(N'Furibisha',N'中飛車',N'里見香奈')
--,(N'Furibisha',N'中飛車',N'加藤圭')
--,(N'Furibisha',N'中飛車',N'香川愛生')
--,(N'Furibisha',N'四間飛車',N'中村真梨花')
--,(N'Furibisha',N'四間飛車',N'石本さくら')
--,(N'Furibisha',N'四間飛車',N'室田伊緒')
--,(N'Furibisha',N'四間飛車',N'上田初美')
--,(N'Furibisha',N'四間飛車',N'山根ことみ')
--,(N'Furibisha',N'三間飛車',N'北村桂香')
--,(N'Furibisha',N'三間飛車',N'甲斐智美')
--,(N'Furibisha',N'三間飛車',N'西山朋佳')
--,(N'Furibisha',N'三間飛車',N'香川愛生')
--,(N'Furibisha',N'三間飛車',N'室田伊緒')
--,(N'Furibisha',N'向かい飛車',N'室谷由紀')
--,(N'Furibisha',N'向かい飛車',N'里見香奈')
--,(N'Furibisha',N'向かい飛車',N'伊藤沙恵')
--,(N'Furibisha',N'向かい飛車',N'香川愛生')
--,(N'Furibisha',N'向かい飛車',N'加藤桃子')
--,(N'Furibisha',N'角交換振り飛車',N'西山朋佳')
--,(N'Furibisha',N'角交換振り飛車',N'石本さくら')
--,(N'Furibisha',N'角交換振り飛車',N'室田伊緒')
--,(N'Furibisha',N'角交換振り飛車',N'中村真梨花')
--,(N'Furibisha',N'角交換振り飛車',N'甲斐智美')
--,(N'Furibisha',N'相振り飛車',N'室谷由紀')
--,(N'Furibisha',N'相振り飛車',N'中村真梨花')
--,(N'Furibisha',N'相振り飛車',N'山根ことみ')
--,(N'Furibisha',N'相振り飛車',N'西山朋佳')
--,(N'Furibisha',N'相振り飛車',N'里見香奈')
--,(N'Ibisha',N'矢倉',N'高橋道雄')
--,(N'Ibisha',N'矢倉',N'佐藤秀司')
--,(N'Ibisha',N'矢倉',N'真田圭一')
--,(N'Ibisha',N'矢倉',N'髙野秀行')
--,(N'Ibisha',N'矢倉',N'行方尚史')
--,(N'Ibisha',N'角換わり',N'丸山忠久')
--,(N'Ibisha',N'角換わり',N'村山慈明')
--,(N'Ibisha',N'角換わり',N'渡辺大夢')
--,(N'Ibisha',N'角換わり',N'豊島将之')
--,(N'Ibisha',N'角換わり',N'糸谷哲郎')
--,(N'Ibisha',N'横歩取り',N'飯島栄治')
--,(N'Ibisha',N'横歩取り',N'船江恒平')
--,(N'Ibisha',N'横歩取り',N'長岡裕也')
--,(N'Ibisha',N'横歩取り',N'横山泰明')
--,(N'Ibisha',N'横歩取り',N'阿久津主税')
--,(N'Ibisha',N'相掛かり',N'山崎隆之')
--,(N'Ibisha',N'相掛かり',N'井上慶太')
--,(N'Ibisha',N'相掛かり',N'横山泰明')
--,(N'Ibisha',N'相掛かり',N'三枚堂達也')
--,(N'Ibisha',N'相掛かり',N'遠山雄亮')
--,(N'Ibisha',N'力戦',N'村田顕弘')
--,(N'Ibisha',N'力戦',N'高橋道雄')
--,(N'Ibisha',N'力戦',N'宮田敦史')
--,(N'Ibisha',N'力戦',N'狩山幹生')
--,(N'Ibisha',N'力戦',N'上村亘')
--,(N'Ibisha',N'対振り飛車',N'折田翔吾')
--,(N'Ibisha',N'対振り飛車',N'岡部怜央')
--,(N'Ibisha',N'対振り飛車',N'徳田拳士')
--,(N'Ibisha',N'対振り飛車',N'塚田泰明')
--,(N'Ibisha',N'対振り飛車',N'上村亘')
--,(N'Furibisha',N'中飛車',N'戸辺誠')
--,(N'Furibisha',N'中飛車',N'近藤正和')
--,(N'Furibisha',N'中飛車',N'菅井竜也')
--,(N'Furibisha',N'中飛車',N'黒沢怜生')
--,(N'Furibisha',N'中飛車',N'今泉健司')
--,(N'Furibisha',N'四間飛車',N'中村亮介')
--,(N'Furibisha',N'四間飛車',N'窪田義行')
--,(N'Furibisha',N'四間飛車',N'井出隼平')
--,(N'Furibisha',N'四間飛車',N'谷合廣紀')
--,(N'Furibisha',N'四間飛車',N'鈴木大介')
--,(N'Furibisha',N'三間飛車',N'西田拓也')
--,(N'Furibisha',N'三間飛車',N'阪口悟')
--,(N'Furibisha',N'三間飛車',N'西川和宏')
--,(N'Furibisha',N'三間飛車',N'南芳一')
--,(N'Furibisha',N'三間飛車',N'山本博志')
--,(N'Furibisha',N'向かい飛車',N'有森浩三')
--,(N'Furibisha',N'向かい飛車',N'杉本昌隆')
--,(N'Furibisha',N'向かい飛車',N'佐藤康光')
--,(N'Furibisha',N'向かい飛車',N'黒沢怜生')
--,(N'Furibisha',N'向かい飛車',N'門倉啓太')
--,(N'Furibisha',N'角交換振り飛車',N'田中悠一')
--,(N'Furibisha',N'角交換振り飛車',N'北浜健介')
--,(N'Furibisha',N'角交換振り飛車',N'藤井猛')
--,(N'Furibisha',N'角交換振り飛車',N'佐藤康光')
--,(N'Furibisha',N'角交換振り飛車',N'安用寺孝功')
--,(N'Furibisha',N'相振り飛車',N'富岡英作')
--,(N'Furibisha',N'相振り飛車',N'宮本広志')
--,(N'Furibisha',N'相振り飛車',N'井上慶太')
--,(N'Furibisha',N'相振り飛車',N'横山友紀')
--,(N'Furibisha',N'相振り飛車',N'古森悠太')
--)as styles(style,substyle,jpname)
--left join kishi on kishi.jpname=styles.jpname
--join (values (N'三間飛車','Sankenbisha')
--,(N'中飛車','Nakabisha')
--,(N'力戦','Rikisen')
--,(N'向かい飛車','Mukaibisha')
--,(N'四間飛車','Shikenbisha')
--,(N'対振り飛車','TaiFuribisha')
--,(N'横歩取り','Yokofudori')
--,(N'相振り飛車','Aifuribisha')
--,(N'相掛かり','Aigakari')
--,(N'矢倉','Yagura')
--,(N'角交換振り飛車','BexFuribisha')
--,(N'角換わり','Kakugawari')
--)as a(n,m)on a.n=substyle
--where kishi._id is not null
--group by styles.jpname,kishi.preferred_style,kishi._id
--)styles where styles._id=kishi._id
